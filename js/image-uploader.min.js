...
! function(e) {
    e.fn.imageUploader = function(t) {
        let n, i = { preloaded: [], imagesInputName: "images", preloadedInputName: "preloaded", label: "Tải ảnh lên", extensions: [".jpg", ".jpeg", ".png", ".gif", ".svg"], mimes: ["image/jpeg", "image/png", "image/gif", "image/svg+xml"], maxSize: void 0, maxFiles: void 0 },
            a = this,
            s = new DataTransfer;
        ...
        let o = function() {
                ...
                return t.on("click", function(e) { d(e), n.trigger("click") }), n.on("click", function(e) { e.stopPropagation() }), n.on("change", p.bind(t)), t
            },
            ...
            l = function(t, i, o) {
                ...
                return l.on("click", function(e) { d(e) }), r.on("click", function(t) {
                    d(t);
                    let o = l.parent();
                    if (!0 === l.data("preloaded")) {
                        let idSanPham = l[0].baseURI.slice(l[0].baseURI.indexOf("#") + 1, l[0].baseURI.length);
                        let link = a.settings.preloaded[0].src.slice(a.settings.preloaded[0].src.lastIndexOf("/") + 1, a.settings.preloaded[0].src.length);
                        deleteImg(idSanPham, link);
                        a.settings.preloaded = a.settings.preloaded.filter(function(e) { return e.id !== i });
                    } else {
            ...
            h = function() { return Date.now() + Math.floor(100 * Math.random() + 1) };
        return this.init(), this
    }
}(jQuery);

function deleteImg(idSanPham, link) {
    $.ajax({
        type: "GET",
        enctype: 'multipart/form-data',
        url: "http://localhost:8080/file/delete/" + idSanPham + "/" + link,
        crossDomain: true,
        contentType: false,
        ...
        error: function(e) {
            console.log("ERROR : ", e);
            alert("Xóa ảnh sản phẩm không thành công!");
            location.reload();
        }
    });
}